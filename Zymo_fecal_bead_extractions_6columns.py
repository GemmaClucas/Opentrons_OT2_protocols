def get_values(*names):
    import json
    _all_values = json.loads("""{"num_col":6,"prewash_buff_vol":300,"elute_buff_vol":50,"engage_height":6.7,"gdna_buff_vol":300,"m300_mount":"right"}""")
...
metadata = {
    'protocolName': 'Zymo Quick-DNA Fecal/Soil Microbe 96 Magbead Kit, 6 columns',
