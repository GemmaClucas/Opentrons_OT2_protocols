def get_values(*names):
    import json
    _all_values = json.loads("""{"num_col":9,"prewash_buff_vol":300,"elute_buff_vol":55,"engage_height":6.7,"gdna_buff_vol":300,"m300_mount":"right"}""")
...
metadata = {
    'protocolName': 'Zymo Quick-DNA Fecal/Soil Microbe 96 Magbead Kit, 9 columns',
